...
function contact() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    let url = `${process.env.API_URL}api/contact`;
            ...
            <div className="mt-12 lg:flex lg:mt-0 lg:flex-col lg:w-1/3">
              <div className="mt-6 space-y-8 md:mt-8">
                <p className="flex items-start mx-2">
                  ...
                  <span className="mx-2">
                  Universal College of Engineering Kaman Bhiwandi Road, Vasai
                  </span>
                </p>
                ...
                <p className="flex items-start mx-2">
                  ...
                  <span className="mx-2 ">7208-25-2036 </span>
                </p>
                ...
                <p className="flex items-start mx-2">
                  ...
                  <span className="mx-2">bajleshparty.info@gmail.com</span>
                </p>
              </div>
