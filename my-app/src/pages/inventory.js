...
const InventoryPage = () => {
  ...
  return (
    ...
    <div className="bg-gradient-to-r from-cyan-900 to-cyan-950 min-h-screen mx-auto px-4 py-8 select-none ">
      <div className='flex justify-between pt-2 bg-white bg-opacity-25 mb-3 rounded-xl mt-20' >
      <div >
        <h1 className="  text-bold shadow-2xl bg-cyan-50 bg-opacity-65 rounded-lg pt-4 mt-4 ml-4 pb-5 pr-5 pl-5 text-3xl text-neutral font-semibold mb-6 flex align-middle">
          <MdOutlineInventory size={45} />
          INVENTORY</h1>
        </div>
     
      <button
        className="btn btn-lg mt-6 border-green-600 bg-green-600 shadow-2xl btn-secondary mr-4   "
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 rounded-lg gap-6">
